...
/datum/controller/subsystem/title/Initialize()
	var/dat
	if(!fexists("[global.config.directory]/phoenix/phoenix_title.txt")) // PHOENIX EDIT: TITLE SCREEN // SPLURT EDIT - original title_html.txt
		to_chat(world, span_boldwarning("CRITICAL ERROR: Unable to read phoenix_title.txt, reverting to backup title html, please check your server config and ensure this file exists.")) // PHOENIX EDIT: TITLE SCREEN  // BUBBER EDIT - original title_html.txt
		dat = DEFAULT_TITLE_HTML
	else
		dat = file2text("[global.config.directory]/phoenix/phoenix_title.txt")  // PHOENIX EDIT: TITLE SCREEN // SPLURT EDIT - original title_html.txt
